...
@section('content')
      <section
        ...
        style="background-image: url(images/about-us-sec.png)"
      >
      ...
      <section class="position-relative overflow-hidden">
        <div class="container">
          <div class="row justify-content-center align-items-center mb-3">
            <div
              class="col-xl-5 col-lg-6 md-mb-14 sm-mb-18 xs-mb-23 position-relative"
            ...
            >
              ...
              <div
                class="w-55 overflow-hidden position-absolute right-15px xs-w-55 bottom-minus-50px"
                data-shadow-animation="true"
            ...
            <div
              class="col-xl-5 offset-xl-1 col-lg-6 text-center text-lg-start"
              data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 800, "delay": 150, "staggervalue": 300, "easing": "easeOutQuad" }'
            >
              <div
                class="swiper position-relative magic-cursor"
      ...
      <!-- start section -->
      <section
        class="bg-gradient-tranquil-white pt-0 position-relative align-items-center"
      >
        <div class="container">
          <div class="row justify-content-center align-items-center row-about">
            <!-- TEXT COLUMN - LEFT -->
            <div
              class="col-xl-5 col-lg-6 position-relative z-index-1 order-1 order-lg-1"
            >
              <div
                class="icon-with-text-style-08 mb-20px"
              ...
              >
                <div class="feature-box feature-box-left-icon-middle">
                  ...
                  >
                    <i
                      class="bi bi-award d-inline-block icon-extra-medium text-dark-gray text-wt"
                    ></i>
                  </div>
                </div>
              </div>
              ...
              <h2
                class="alt-font text-dark-gray fw-600 ls-minus-3px mb-40px sm-mb-30px"
              ...
              <!-- ACCORDION -->
              <div
                class="accordion accordion-style-05"
                id="accordion-style-05"
                data-anime='{ "el": "childs", "translateY": [-30, 0], "perspective": [1200,1200], "scale": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'
              >
                <!-- accordion items here (UNCHANGED) -->
                <div class="accordion-item bg-white active-accordion">
                  ...
                  >
                    <div
                      class="accordion-body last-paragraph-no-margin"
                      style="color: #717580"
                    >
                      <p>
                        To deliver reliable and sustainable water solutions
                        including professional borehole drilling, modern
                        irrigation systems, and durable bush pump installations
                        that improve livelihoods, support agriculture, and
                        empower communities with consistent access to water.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item bg-white">
                  ...
                  >
                    ...
                    >
                      <p>
                        To become the leading provider of innovative and
                        long-lasting water systems in the region, ensuring every
                        household, farm, and community has access to clean,
                        dependable, and affordable water for generations to
                        come.
                      </p>
                    </div>
                  </div>
                ...
                <div class="accordion-item bg-white">
                  ...
                  >
                    ...
                    >
                      <p>
                        At Mighty Breeze, our work is guided by a strong
                        commitment to
                        <b>
                          reliability, integrity, expertise, sustainability, and
                          community focus</b
                        >. We deliver water solutions that are built to last,
                        ensuring dependable performance in every borehole,
                        irrigation system, and bush pump we install. We believe
                        in operating with honesty and transparency, providing
            ...
            <!-- IMAGE COLUMN - RIGHT -->
            <div
              class="d-none d-lg-block col-xl-7 col-lg-6 text-center order-2 order-lg-2"
              data-anime='{ "el": "childs", "opacity": [0,1], "duration": 600, "delay": 100, "staggervalue": 300, "easing": "easeOutQuad" }'
            >
              <div
                class="position-relative md-mb-50px xs-mb-30px ps-50px outside-box-right-10 md-outside-box-right-0 lg-pe-0 atropos"
                data-atropos
              >
                <div class="atropos-scale">
                  <div class="atropos-rotate">
                    <div
                      class="atropos-inner text-center w-100 overflow-visible"
                    >
                      <div
                        data-atropos-offset="-1"
                        class="position-absolute right-0px"
                      >
