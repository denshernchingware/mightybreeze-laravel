...
@section('content')
 ...
 <!-- start page title -->
            <section class="top-space-margin page-title-big-typography border-radius-6px lg-border-radius-0px p-0" data-parallax-background-ratio="0.5" style="background-image: url(images/contact.png)">
            ...
            <!-- end section -->
            <!-- start section -->
            <section class="d-none d-lg-block position-relative one-half-screen sm-small-screen overflow-hidden border border-radius-top-lr lg-border-radius-0px" data-parallax-background-ratio="0.5" style="background-image: url(images/contact-img.png)">
                <div class="opacity-light bg-dark-gray"></div>
                <div class="fs-225 ls-minus-10px alt-font text-gradient-orange-sky-blue fw-600 position-absolute left-minus-25px bottom-minus-50px sm-ls-minus-5px sm-bottom-minus-20px sm-fs-200 xs-left-minus-10px xs-fs-130"></div>
            </section>
            <!-- end section -->
            <!-- start section -->
            <section class="bg-gradient-quartz-white position-relative z-index-0 sm-pt-0">
                <div class="container-fluid overlap-section p-0">
                    ...
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m12!1m8!1m3!1d4666.925486232064!2d31.044057000000002!3d-17.893834!3m2!1i1024!2i768!4f13.1!2m1!1s3%20New%20Davies%20Prospect%20Waterfalls%2C%20Harare!5e1!3m2!1sen!2sus!4v1764595052376!5m2!1sen!2sus"
                        width="100%"
                        height="450"
