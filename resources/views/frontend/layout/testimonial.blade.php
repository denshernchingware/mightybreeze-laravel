<section class="bg-gradient-quartz-white border-radius-6px lg-border-radius-0px pb-0">
    <div class="container background-no-repeat background-position-top"
        ...
        <div class="row justify-content-center pb-0 mb-0">
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9 text-center test"
        ...
        <div class="row justify-content-center align-items-center mb-6 sm-mb-8"
            ...
            <div class="col-12 position-relative ps-8 pe-8 lg-ps-15px lg-pe-15px mt-0">
                <div class="swiper magic-cursor testimonials-style-06"
                    data-slider-options='{ "loop": true, "autoplay": { "delay": 12000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "navigation": { "nextEl": ".swiper-button-next-nav", "prevEl": ".swiper-button-previous-nav", "effect": "fade" } }'>
                            ...
                            <div class="swiper-slide">
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                        ...
                                        <span
                                            class="mb-5px d-table fs-18 lh-30 fw-500 text-dark-gray text-center">{{ $testimonial->description }}</span>
                                        <div class="fs-15 text-uppercase fw-800 text-base-color ls-1px text-center">
                                            {{ $testimonial->name }} </div>
                                        <div
                                            class="fs-15 text-uppercase fw-800 text-base-color ls-1px mt-0 text-center">
                                            {{ $testimonial->phone_number }}</div>
