...
@section('content')
    ...
    <section id="slider" class="p-0 top-space-margin">
        <div class="demo-corporate-slider_wrapper" data-alias="portfolio-viewer" data-source="gallery"
            style="background-color: transparent; padding: 0px">
            <div id="demo-corporate-slider" class="rev_slider bg-regal-blue" style="display: none; margin-top: 0"
                ...
                <ul>
                    ...
                    <li data-index="rs-01" data-transition="parallaxleft" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper" id="slide-1-layer-01"
                            ...
                            style="background: rgba(22, 35, 63, 0.1); z-index: 0"></div>
                        <!-- end overlay layer -->
                        <!-- start shape layer -->
                            ...
                            <div class="tp-caption" id="slide-1-layer-04" data-x="['left','left','left','left']"
                                ...
                                <div class="tp-caption" id="slide-1-layer-05" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption mx-auto text-uppercase" id="slide-1-layer-06"
                                        ...
                                        <i class="bi bi-award pe-5px icon-small"></i>Drilling expertise, sustaining your
                                        future
                                    </div>
                                    <!-- end subtitle layer -->
                                    <!-- start title layer -->
                        ...
                        ">
                                        MightyBreeze Borehole Drilling and Siting
                                    ...
                                    <div class="tp-caption mx-auto" id="slide-1-layer-08"
                                        ...
                                        data-paddingleft="[0,0,0,0]">
                                        Delivering expert borehole and siting services that empower homes, farms, and
                                        businesses with dependable water access.
                                    </div>
                                    <!-- end text layer -->
                                    <!-- start button layer -->
                                    <div class="tp-caption tp-resizeme" id="slide-1-layer-09"
                                        ...
                                        <a href="{{ route('contact') }}"
                                            class="btn btn-extra-large get-started-btn btn-rounded with-rounded btn-gradient-flamingo-amethyst-green btn-box-shadow">Contact
                                            Us<span class="bg-white text-base-color"><i
                        ...
                        <div class="tp-caption d-inline-block" id="slide-1-layer-11"
                            ...
                            <i class="bi bi-patch-check-fill icon-extra-medium d-block pb-10px"></i>
                            <span class="d-block text-uppercase">Decided quality</span>
                        </div>
                    ...
                    <li data-index="rs-02" data-transition="parallaxleft" data-slotamount="default"
                            ...
                            <div class="tp-caption" id="slide-2-layer-04" data-x="['left','left','left','left']"
                                ...
                                <div class="tp-caption" id="slide-2-layer-05" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption mx-auto text-uppercase" id="slide-2-layer-06"
                                        ...
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[25,25,10,10]"
                                        data-paddingleft="[0,0,0,0]" style="word-break: initial">
                                        <i class="bi bi-award pe-5px icon-small"></i>Solar Install Support
                                    </div>
                                    <!-- end subtitle layer -->
                                    <!-- start title layer -->
                        ...
                        ">
                                    ...
                                    <div class="tp-caption mx-auto" id="slide-2-layer-08"
                                        ...
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[36,36,60,40]"
                                        data-paddingleft="[0,0,0,0]">
                                        MightyBreeze is a dedicated solar solutions partner offering precision installations
                    ...
                    <li data-index="rs-03" data-transition="parallaxleft" data-slotamount="default"
                        ...
                        data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- slide's main background image -->
                        <img src="images/slider-three.png" alt="Image" data-bgposition="center center"
                            data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina />
                        <!-- start overlay layer -->
                            ...
                            <div class="tp-caption" id="slide-3-layer-04" data-x="['left','left','left','left']"
                                ...
                                <div class="tp-caption" id="slide-3-layer-05" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption mx-auto text-uppercase" id="slide-3-layer-06"
                                        ...
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[25,25,10,10]"
                                        data-paddingleft="[0,0,0,0]" style="word-break: initial">
                                        <i class="bi bi-award pe-5px icon-small"></i>Instant Support for Irrigation
                                    </div>
                                    <!-- end subtitle layer -->
                                    <!-- start title layer -->
                        ...
                        ">
                                    ...
                                    <div class="tp-caption mx-auto" id="slide-3-layer-08"
                                        ...
                                        data-paddingright="[0,0,0,0]" data-paddingbottom="[36,36,60,40]"
                                        data-paddingleft="[0,0,0,0]">
                                        We're a fully dedicated irrigation solutions provider, partnering with farms and
    ...
    <!-- end slider -->
    <!-- start section -->
    <section class="d-none d-lg-block pt-0 pb-0 border-bottom border-color-extra-medium-gray">
            ...
            <div class="row row-cols-1 row-cols-md-3 row-cols-sm-2 justify-content-center"
                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            <span class="lh-24 fw-600 d-block">Expert monitoring and <br />optimization of irrigation
                                systems.</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <span class="lh-24 fw-600 d-block">Best rated firm</span>
                        </div>
                    </div>
                </div>
                <!-- end content box item -->
                <!-- start content box item -->
                <div class="col pt-35px pb-35px text-dark-gray" id="stats">
                    <div
                        class="d-flex flex-column flex-lg-row align-items-center justify-content-center text-center text-lg-start">
                        <div class="flex-shrink-0 me-15px md-me-0">
    ...
    <!-- end section -->
    <!-- start section -->
    <section class="mt-sm-0 pt-sm-0 abt">
        <div class="container">
            <div class="row justify-content-center align-items-center mb-6 mt-8 sm-pb-9">
                <div class="col-lg-6 ps-6 text-center text-lg-start lg-ps-15px"
                    ...
                    <span
                        class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">About</span>
                    ...
                    <span class="text-dark-gray fw-700 ls-minus-05px d-block d-sm-inline-block sm-mt-15px"><a
                            href="tel:+263771060581"><i class="feather icon-feather-phone-call me-10px"></i>+263&nbsp;77&nbsp;106 &nbsp;0581</a></span>
                ...
                <div class="col-lg-6 col-md-9 position-relative md-mb-15 text-center text-lg-start d-flex align-items-center justify-content-center"
                    ...
                    <div class="position-absolute z-index-9 counter-style-02 text-center">
                        <span
                            class="fs-160 fw-800 text-dark-gray ls-minus-10px xs-ls-minus-5px position-relative lg-fs-130 xs-fs-75">14<sub
                                class="align-top fs-80 lg-fs-70 text-dark-gray position-relative top-minus-3px">+</sub></span>
                        <span class="d-block mx-auto fs-20 fw-500 lh-26 w-70 text-center text-dark-gray xs-w-100"><strong>Years
                                working experience</strong></span>
                    </div>
                    <img src="{{ asset('images/hero.png') }}" alt="" />
                    <img src="images/experience-sec.png"
            ...
            <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 justify-content-center counter-style-07 ps-3 pe-3"
                ...
                <!-- start counter item -->
                <div class="col text-center sm-mb-0 pb-0 ">
                    ...
                    <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">Completed Projects</span>
                </div>
                <!-- end counter item -->
                <!-- start counter item -->
                <div class="col text-center sm-mb-0 pb-0">
                    ...
                    <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">Solar`s Installed</span>
                </div>
                <!-- end counter item -->
                <!-- start counter item -->
                <div class="col text-center sm-mb-0 pb-0">
                    ...
                    <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">Boreholes drilled</span>
                </div>
                <!-- end counter item -->
                <!-- start counter item -->
                <div class="col text-center sm-mb-0 pb-0">
            ...
            <div class="row align-items-center mb-6 sm-mb-9 text-center text-lg-start">
                ...
                <div class="col-lg-5 last-paragraph-no-margin md-mb-20px">
                    <p class="w-85 md-w-100">
                        We strive to deliver practical, real-world solutions in borehole drilling, irrigation, and solar
                        installation, customized to meet the unique needs of every project, large or small.
                    </p>
                </div>
                        ...
                        <div class="swiper magic-cursor slider-one-slide"
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span class="text-white fw-600 fs-20">Borehole Drilling</span>
                                                <span
                                                    class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Reliable
                                                    extraction</span>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                <span class="text-white fw-600 fs-20">Irrigation</span>
                                                <span
                                                    class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Crop-boosting</span>
                                                <a href="{{ route('services') }}"
                                                    class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                    services</a>
                                                <span
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div
                                        class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                        <img src="images/bush-pump-serv.png" alt="" />
                                        <div class="opacity-very-light bg-slate-blue"></div>
                                        <div
                                            class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                            <div class="hover-label-icon position-relative z-index-9">
                                            ...
                                            <div
                                                class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                <span class="text-white fw-600 fs-20">Bush Pump</span>
                                                <span
                                                    class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Hand-operated</span>
                                                <a href="{{ route('services') }}"
                                                    class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                    services</a>
                                                <span
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div
                                        class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                        <img src="images/sollar-install-serv.png" alt="" />
                                        <div class="opacity-very-light bg-slate-blue"></div>
                                        <div
                                            class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                            <div class="hover-label-icon position-relative z-index-9">
                                            ...
                                            <div
                                                class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                <span class="text-white fw-600 fs-20">Home and Borehole</span>
                                                <span
                                                    class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Energy-saving</span>
                                                <a href="{{ route('services') }}"
                                                    class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                    services</a>
                                                <span
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20"> {{ $service->title }} </span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">{{ $service->description }}</span>
                                                    <a href="{{ route('services') }}"
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                                    <span
            ...
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <div class="fs-18 text-white d-inline-block align-middle">
                        ...
                        <a href="{{ route('contact') }}" class="text-white text-decoration-line-bottom">Contact us
                            now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-auto text-center">
                        ...
                        <span
                            class="btn btn-medium btn-dark-gray btn-box-shadow btn-rounded text-transform-none primary-font d-inline-flex align-items-center gap-2">
                            View More
